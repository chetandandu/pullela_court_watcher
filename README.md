...
2.  i. The URL has two parts - <br>
        - path : https://adminbooking.gopichandacademy.com/API/Get/Calender <br>
        - query string : venue_id=3&date=2026-07-18 <br>
...
4. If the slots were open, we send a message to my telegram using a bot. This bot was created using botfather.<br>
   - The botfather generates a `BOT_TOKEN` for HTTP API. We will know the `CHAT_ID` once we access the API. <br>
   - The `BOT_TOKEN` and `CHAT_ID` were masked using *secrets* feature in github.<br>
